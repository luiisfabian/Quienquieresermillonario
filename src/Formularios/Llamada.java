...
import java.applet.AudioClip; // libreria para agregar sonido a las aplicaciones
...
public class Llamada extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingrese el numero del telefono al cual desea llamar para pedir la ayuda");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setText("¡Recurde Que tiene 30 segundos despues de que la otra persona conteste en la linea!");

        jLabel3.setText("Numero telefonico del contacto:");
